...
module Decidim
  module Meetings
    ...
    class JoinMeeting < Rectify::Command
      ...
      def follow_meeting
        # OSP OVERRIDES for meetings registrations auto follow
        # - origin :
        # Decidim::CreateFollow.call(follow_form, user)
        # - override :
        Decidim::CreateFollow.call(follow_form, user) unless Decidim::Follow.exists?(user: user, followable: @meeting)
      end
